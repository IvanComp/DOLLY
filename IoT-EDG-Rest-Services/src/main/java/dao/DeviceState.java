...
public abstract class DeviceState 
    ...
    public void check_mecrdevice() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 279 with name MEcrDevice for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddevice() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meenddevice...");
        throw new MerodeException ("[" + Instant.now() + "]" + " Can't execute event 280 with name MEendDevice for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceresult() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecrdeviceresult...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 283 with name MEcrDeviceResult for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceresult() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meenddeviceresult...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 284 with name MEendDeviceResult for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecroutcome() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecroutcome...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 281 with name MEcrOutcome for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meendoutcome() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meendoutcome...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 282 with name MEendOutcome for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrpropertyoutcome() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecrpropertyoutcome...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 295 with name MEcrPropertyOutcome for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meendpropertyoutcome() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meendpropertyoutcome...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 296 with name MEendPropertyOutcome for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceusage() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecrdeviceusage...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 291 with name MEcrDeviceUsage for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceusage() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meenddeviceusage...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 292 with name MEendDeviceUsage for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_deviceundeployment() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.deviceundeployment...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 294 with name DeviceUndeployment for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_devicedeployment() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.devicedeployment...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 293 with name DeviceDeployment for object type 1 named Device in state " + getStateId() + " called " + getStateName());
    }
