                    ...
                    <div className="library-container"
                        ...
                        {deviceArray.map((item: any, index: number) => (
                            <div key={index} className="platform-device">
                                ...
                                <div style={{display: 'flex', gap: '10px'}}>
                                    <button style={{fontSize: "12px", backgroundColor: '#da1540', color: 'white', fontWeight: "bold", padding: '5px 13px', border: '2px solid red', borderRadius: '3px', cursor: 'pointer', position: 'relative', bottom: '-5px'}} onClick={() => endDevice(index)}>End Device</button>
                                    <button style={{fontSize: "12px", backgroundColor: '#da1540', color: 'white', fontWeight: "bold", padding: '5px 13px', border: '2px solid red', borderRadius: '3px', cursor: 'pointer', position: 'relative', bottom: '-5px'}} onClick={() => deleteDevice(index)}>Delete Device</button>
                                </div>
