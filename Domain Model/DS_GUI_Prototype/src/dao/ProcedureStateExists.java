...
public class ProcedureStateExists extends ProcedureState {
    ...
    public void meendprocedure (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ...
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 64");
    ...
    public void devicedeployment (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ...
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 67");
        object.setState(state);
    }
    ...
    public void deviceundeployment (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ProcedureStateExists state = ProcedureStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 69");
        object.setState(state);
    }
    ...
    public void mecrdeviceresult (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ProcedureStateExists state = ProcedureStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 71");
        object.setState(state);
    }
    ...
    public void mecrdeviceusage (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ProcedureStateExists state = ProcedureStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 73");
        object.setState(state);
    }
    ...
    public void meenddeviceresult (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ProcedureStateExists state = ProcedureStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 75");
        object.setState(state);
    }
    ...
    public void meenddeviceusage (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ProcedureStateExists state = ProcedureStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 77");
        object.setState(state);
    }
    ...
    public void mesetready (org.hibernate.Session sess, Procedure object) throws org.hibernate.HibernateException {
        ProcedureStateExists state = ProcedureStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 52 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 79");
        object.setState(state);
    }
