...
public abstract class DeviceState 
    ...
    public void check_mecrdevice() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 388 with name MEcrDevice for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddevice() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meenddevice...");
        throw new MerodeException ("[" + Instant.now() + "]" + " Can't execute event 389 with name MEendDevice for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceresult() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecrdeviceresult...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 373 with name MEcrDeviceResult for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceresult() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meenddeviceresult...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 374 with name MEendDeviceResult for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrregistereddevice() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 369 with name MEcrRegisteredDevice for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meendregistereddevice() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 370 with name MEendRegisteredDevice for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrprocedure() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecrprocedure...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 371 with name MEcrProcedure for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meendprocedure() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meendprocedure...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 372 with name MEendProcedure for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceusage() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mecrdeviceusage...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 381 with name MEcrDeviceUsage for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceusage() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.meenddeviceusage...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 382 with name MEendDeviceUsage for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_deviceundeployment() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.deviceundeployment...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 384 with name DeviceUndeployment for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_devicedeployment() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.devicedeployment...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 383 with name DeviceDeployment for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
    public void check_mesetready() throws MerodeException {
        MerodeLogger.logln ("Checking DeviceState.mesetready...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 385 with name MEsetReady for object type 318 named Device in state " + getStateId() + " called " + getStateName());
    }
