...
public abstract class PlatformdeploymentState 
    ...
    public void check_mecrplatformdeployment() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 386 with name MEcrPlatformDeployment for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_meendplatformdeployment() throws MerodeException {
        ...
        throw new MerodeException ("[" + Instant.now() + "]" + " Can't execute event 387 with name MEendPlatformDeployment for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceresult() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 373 with name MEcrDeviceResult for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceresult() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 374 with name MEendDeviceResult for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceusage() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 381 with name MEcrDeviceUsage for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceusage() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 382 with name MEendDeviceUsage for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_deviceundeployment() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 384 with name DeviceUndeployment for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_devicedeployment() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 383 with name DeviceDeployment for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
    public void check_mesetready() throws MerodeException {
        MerodeLogger.logln ("Checking PlatformdeploymentState.mesetready...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 385 with name MEsetReady for object type 289 named Platformdeployment in state " + getStateId() + " called " + getStateName());
    }
