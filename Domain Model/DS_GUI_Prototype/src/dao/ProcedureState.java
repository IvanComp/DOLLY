...
public abstract class ProcedureState 
    ...
    public void check_mecrprocedure() throws MerodeException {
        ...
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 371 with name MEcrProcedure for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_meendprocedure() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.meendprocedure...");
        throw new MerodeException ("[" + Instant.now() + "]" + " Can't execute event 372 with name MEendProcedure for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceresult() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.mecrdeviceresult...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 373 with name MEcrDeviceResult for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceresult() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.meenddeviceresult...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 374 with name MEendDeviceResult for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_mecrdeviceusage() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.mecrdeviceusage...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 381 with name MEcrDeviceUsage for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_meenddeviceusage() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.meenddeviceusage...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 382 with name MEendDeviceUsage for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_deviceundeployment() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.deviceundeployment...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 384 with name DeviceUndeployment for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_devicedeployment() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.devicedeployment...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 383 with name DeviceDeployment for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
    public void check_mesetready() throws MerodeException {
        MerodeLogger.logln ("Checking ProcedureState.mesetready...");
        throw new MerodeException("[" + Instant.now() + "]" + " Can't execute event 385 with name MEsetReady for object type 52 named Procedure in state " + getStateId() + " called " + getStateName());
    }
