...
public class RegistereddeviceViewWindow extends ObjectViewPanel {
	...
	public void setTitledBorder(dao.Registereddevice obj){
    	setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder("Registereddevice : " + obj.getDevicename()),
    ...
    protected void completeAttributesPane() {
		...
		Object[][] data = { { "<html><font color='blue'>GeneratedID</font></html>", ((dao.Registereddevice)object).getId() },
	            			{ "<html><font color='blue'>Devicename</font></html>", ((dao.Registereddevice)object).getDevicename()},
	            			{ "<html><font color='blue'>Platformname</font></html>", ((dao.Registereddevice)object).getPlatformname()},
	            			{ "<html><font color='blue'>Starttime</font></html>", ((dao.Registereddevice)object).getStarttime()},
