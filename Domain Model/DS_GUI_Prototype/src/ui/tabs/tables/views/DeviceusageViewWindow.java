...
public class DeviceusageViewWindow extends ObjectViewPanel {
	...
	public void setTitledBorder(dao.Deviceusage obj){
    	setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder("Deviceusage : " + obj.getUsagetype()),
    ...
    protected void completeAttributesPane() {
		...
		Object[][] data = { { "<html><font color='blue'>GeneratedID</font></html>", ((dao.Deviceusage)object).getId() },
	            			{ "<html><font color='blue'>Usagetype</font></html>", ((dao.Deviceusage)object).getUsagetype()},
	            			{ "<html><font color='blue'>Starttime</font></html>", ((dao.Deviceusage)object).getStarttime()},
	            			{ "<html><font color='blue'>Endtime</font></html>", ((dao.Deviceusage)object).getEndtime()},
