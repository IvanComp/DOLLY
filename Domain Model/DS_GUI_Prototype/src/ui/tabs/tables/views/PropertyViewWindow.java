...
public class PropertyViewWindow extends ObjectViewPanel {
	...
	public void setTitledBorder(dao.Property obj){
    	setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder("Property : " + obj.getFeatureofinterestname()),
    ...
    protected void completeAttributesPane() {
		...
		Object[][] data = { { "<html><font color='blue'>GeneratedID</font></html>", ((dao.Property)object).getId() },
	            			{ "<html><font color='blue'>Featureofinterestname</font></html>", ((dao.Property)object).getFeatureofinterestname()},
	            			{ "<html><font color='blue'>Description</font></html>", ((dao.Property)object).getDescription()},
