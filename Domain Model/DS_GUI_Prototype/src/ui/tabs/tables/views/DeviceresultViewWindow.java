...
public class DeviceresultViewWindow extends ObjectViewPanel {
	...
	public void setTitledBorder(dao.Deviceresult obj){
    	setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder("Deviceresult : " + obj.getValue()),
    ...
    protected void completeAttributesPane() {
		...
		Object[][] data = { { "<html><font color='blue'>GeneratedID</font></html>", ((dao.Deviceresult)object).getId() },
	            			...
	            			{ "<html><font color='blue'>Unit</font></html>", ((dao.Deviceresult)object).getUnit()},
	            			{ "<html><font color='blue'>Producedby</font></html>", ((dao.Deviceresult)object).getProducedby()},
	            			{ "<html><font color='blue'>Observedproperty</font></html>", ((dao.Deviceresult)object).getObservedproperty()},
	            			{ "<html><font color='blue'>Starttime</font></html>", ((dao.Deviceresult)object).getStarttime()},
	            			{ "<html><font color='blue'>Endtime</font></html>", ((dao.Deviceresult)object).getEndtime()},
