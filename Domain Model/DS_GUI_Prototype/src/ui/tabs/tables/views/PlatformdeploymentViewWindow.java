...
public class PlatformdeploymentViewWindow extends ObjectViewPanel {
	...
	public void setTitledBorder(dao.Platformdeployment obj){
    	setBorder(BorderFactory.createCompoundBorder(
                BorderFactory.createTitledBorder("Platformdeployment : " + obj.getPlatformname()),
    ...
    protected void completeAttributesPane() {
		...
		Object[][] data = { { "<html><font color='blue'>GeneratedID</font></html>", ((dao.Platformdeployment)object).getId() },
	            			{ "<html><font color='blue'>Platformname</font></html>", ((dao.Platformdeployment)object).getPlatformname()},
	            			{ "<html><font color='blue'>Featureofinterestname</font></html>", ((dao.Platformdeployment)object).getFeatureofinterestname()},
	            			{ "<html><font color='blue'>Starttime</font></html>", ((dao.Platformdeployment)object).getStarttime()},
