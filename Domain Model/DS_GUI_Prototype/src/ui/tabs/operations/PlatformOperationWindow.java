...
public abstract class PlatformOperationWindow extends JFrame {
    ...
    protected JTextField t_Hostedby;
    ...
    private void constructAttributePane(Container p) {
        ...
        JLabel l_Hostedby = new JLabel("Hostedby [Long text]: ", JLabel.TRAILING);
        att_p.add(l_Hostedby);

        t_Hostedby = new JTextField(15);
        t_Hostedby.setMaximumSize(new Dimension(400, 40));
        l_Hostedby.setLabelFor(t_Hostedby);
        
        att_p.add(t_Hostedby);
