...
public abstract class DeviceOperationWindow extends JFrame {
    ...
    private void constructAttributePane(Container p) {
        ...
        JLabel l_Status = new JLabel("Status [Boolean]: ", JLabel.TRAILING);
        att_p.add(l_Status);

        t_Status = new JTextField(15);
        t_Status.setMaximumSize(new Dimension(400, 40));
        l_Status.setLabelFor(t_Status);
