...
public class DeviceusagemesetreadyWindow extends DeviceusageOperationWindow {
    ...
    private void fillTextFields() {
        t_Usagetype.setText (object.getUsagetype());
        t_Starttime.setText (object.getStarttime());
        t_Endtime.setText (object.getEndtime());
    ...
    protected void executeMethod() {
        try {
            ...
            if (t_Usagetype.getText().trim().length()==0) {
                hasErrors = true;
                errors = errors + "Please fill in attribute: Usagetype\n";
            }
            ...
            if (hasErrors) {
                ...
                main_handler.mesetready (object.getId(), 
                							 t_Usagetype.getText(), t_Starttime.getText(),t_Endtime.getText());
