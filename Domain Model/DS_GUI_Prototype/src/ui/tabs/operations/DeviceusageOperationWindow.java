...
public abstract class DeviceusageOperationWindow extends JFrame {
    ...
    protected JTextField t_Usagetype;
    ...
    private void constructAttributePane(Container p) {
        ...
        JLabel l_Usagetype = new JLabel("Usagetype [String]: ", JLabel.TRAILING);
        att_p.add(l_Usagetype);

        t_Usagetype = new JTextField(15);
        t_Usagetype.setMaximumSize(new Dimension(400, 40));
        l_Usagetype.setLabelFor(t_Usagetype);
        
        att_p.add(t_Usagetype);
...
//		});
        ...
        UIManager.put("JXDatePicker.arrowIcon", new ImageIcon(DeviceusageOperationWindow.class.getResource("calendar.png")));
