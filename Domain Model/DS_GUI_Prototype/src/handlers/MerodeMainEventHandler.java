...
public class MerodeMainEventHandler {
	...
	protected boolean handleMecrregistereddevice(org.hibernate.Session sess,
		...
		if ("dao.PlatformImpl".equals(platform.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + registereddevice.getId() + " of object type 1 related to " + platform.getId() + " with attributes java.lang.String Devicename java.lang.String Platformname java.lang.String Starttime");
		} 
		else {
		}
		// inheritance support: one of the instances is correct, either supertype or subtype
		if ("dao.DeviceImpl".equals(device.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + registereddevice.getId() + " of object type 1 related to " + device.getId() + " with attributes java.lang.String Devicename java.lang.String Platformname java.lang.String Starttime");
		} 
		else {
		}
	...
	protected boolean handleMecrprocedure(org.hibernate.Session sess,
		...
		if ("dao.DeviceImpl".equals(device.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + procedure.getId() + " of object type 52 related to " + device.getId() + " with attributes java.lang.String Devicename java.lang.String Description");
		} 
		else {
		}
	...
	protected boolean handleMecrdeviceresult(org.hibernate.Session sess,
		...
		if ("dao.DeviceusageImpl".equals(deviceusage.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + deviceresult.getId() + " of object type 80 related to " + deviceusage.getId() + " with attributes java.lang.String Value java.lang.String Unit java.lang.String Producedby java.lang.String Observedproperty java.lang.String Starttime java.lang.String Endtime");
		} 
		else {
		}
	...
	protected boolean handleMecrfeatureofinterest(org.hibernate.Session sess,
		...
		MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object type 97 with attributes java.lang.String Name java.lang.String Description");
		// save object in database
	...
	protected boolean handleMecrplatform(org.hibernate.Session sess,
		...
		MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object type 147 with attributes java.lang.String Name java.lang.String Description java.lang.String Hostedby");
		// save object in database
		sess.save(platform);
		// check user and state preconditions
	...
	protected boolean handleMecrproperty(org.hibernate.Session sess,
		...
		if ("dao.FeatureofinterestImpl".equals(featureofinterest.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + property.getId() + " of object type 198 related to " + featureofinterest.getId() + " with attributes java.lang.String Featureofinterestname java.lang.String Description");
		} 
		else {
		}
	...
	protected boolean handleMecrdeviceusage(org.hibernate.Session sess,
		...
		if ("dao.PlatformdeploymentImpl".equals(platformdeployment.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + deviceusage.getId() + " of object type 226 related to " + platformdeployment.getId() + " with attributes java.lang.String Usagetype java.lang.String Starttime java.lang.String Endtime");
		} 
		else {
		}
		// inheritance support: one of the instances is correct, either supertype or subtype
		if ("dao.RegistereddeviceImpl".equals(registereddevice.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + deviceusage.getId() + " of object type 226 related to " + registereddevice.getId() + " with attributes java.lang.String Usagetype java.lang.String Starttime java.lang.String Endtime");
		} 
		else {
		}
		// inheritance support: one of the instances is correct, either supertype or subtype
		if ("dao.ProcedureImpl".equals(procedure.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + deviceusage.getId() + " of object type 226 related to " + procedure.getId() + " with attributes java.lang.String Usagetype java.lang.String Starttime java.lang.String Endtime");
		} 
		else {
		}
		// inheritance support: one of the instances is correct, either supertype or subtype
		if ("dao.PropertyImpl".equals(property.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + deviceusage.getId() + " of object type 226 related to " + property.getId() + " with attributes java.lang.String Usagetype java.lang.String Starttime java.lang.String Endtime");
		} 
		else {
		}
	...
	protected boolean handleMecrplatformdeployment(org.hibernate.Session sess,
		...
		if ("dao.PlatformImpl".equals(platform.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + platformdeployment.getId() + " of object type 289 related to " + platform.getId() + " with attributes java.lang.String Platformname java.lang.String Featureofinterestname java.lang.String Starttime");
		} 
		else {
		}
		// inheritance support: one of the instances is correct, either supertype or subtype
		if ("dao.FeatureofinterestImpl".equals(featureofinterest.getClass().getName())) {
			...
			MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object " + platformdeployment.getId() + " of object type 289 related to " + featureofinterest.getId() + " with attributes java.lang.String Platformname java.lang.String Featureofinterestname java.lang.String Starttime");
		} 
		else {
		}
	...
	protected boolean handleMecrdevice(org.hibernate.Session sess,
		...
		MerodeLogger.logln("[" + Instant.now() + "]" + " Initializing object type 318 with attributes java.lang.String Name java.lang.String Description java.lang.String Status");
		// save object in database
		sess.save(device);
		// check user and state preconditions
