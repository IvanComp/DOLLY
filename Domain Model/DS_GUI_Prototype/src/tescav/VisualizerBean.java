...
public class VisualizerBean {
	...
	public String getHelpText(){
		String helpText = "<html><font size=+1><b>TesCaV help</b><br><br>" + 
							"<font size=-1>TesCaV gives feedback about testing by visualizing which test cases have been tested. <br><br>" +
							"1. Select an object in the dropdown menu<br>" +
							"2. Click \"View\" next to a criterion to get additional feedback about that criterion<br>" +
							"3. Red elements have not been tested yet, green elements have been tested.<br>" + 
							"4. Reopen TesCaV to refresh the feedback <br><br><br><br><br><br>" +
							"Optional: get extra help on specific criterion:<br>" +
							"</html>" ;
		return helpText;
	...
	public JComboBox<String> getComboBoxCriteria(){

		String [] criteria = new String[getCriteriaAmount()];

		// For each criterion
		for (int i = 0; i < getCriteriaAmount(); i++) {

			final int ix = i;

			final String criterion = getCriterionName(i);

			String text = "<html><font size=+1>" + criterion;
			criteria[i] = text;		
		}
		JComboBox<String> criteriaList = new JComboBox<String>(criteria);	
