...
public class ObjectM {
    ...
    public ArrayList<Integer> ownedEventIds;
    public ArrayList<Integer> acqEventIds;
    ...
    public ObjectM(Element object, ArrayList<Pair<String, String>> dependents, ArrayList<String> children, ArrayList<Integer> ownedEventIds, ArrayList<Integer> acqEventIds) {
        name = object.getAttribute("name");
    ...
    // Return object owned methods
    public ArrayList<Integer> getOwnedEventIds(){
    	return this.ownedEventIds;
    }

    // Return object acquired methods
    public ArrayList<Integer> getAcquiredEventIds(){
    	return this.acqEventIds;
    }
    ...
    // Get intermediate state IDs of a given FSM
    public ArrayList<Integer> getIntermediateStateIds(int i){
    	return fsms.get(i).getIntermediateStateIds();
    }

    // Get ending state IDs of a given FSM
    public ArrayList<Integer> getEndingStatesIds(int i){
    	return fsms.get(i).getEndingStatesIds();
    }
    ...
    public class Fsm {
        ...
        // Return the intermediate state IDs
        public ArrayList<Integer> getIntermediateStateIds(){
        	ArrayList<Integer> stateIds = new ArrayList<Integer>();
        	for(int i=0; i<states.size(); i++){
        		if("STATE".equals(getStateType(i))){		
        			int id = getStateId(i);
                    stateIds.add(id);
        		}
        	}
        ...
        // Return the ending state ID
        public ArrayList<Integer> getEndingStatesIds(){
            ArrayList<Integer> stateIds = new ArrayList<Integer>();
        	for(int i=0; i<states.size(); i++){
        		if("FINAL_STATE".equals(getStateType(i))){		
        			int id = getStateId(i);
                    stateIds.add(id);
        		}
        	}
