...
public abstract class ProcedureFactory {
    ...
    */
    ...
    public static java.util.Collection findByDevicename (org.hibernate.Session sess, java.lang.String Devicename)
        ...
        org.hibernate.Query q = sess.createQuery("from dao.Procedure as c where c.Devicename = ?");
    ...
    public static java.util.Collection findByDescription (org.hibernate.Session sess, java.lang.String Description)
        ...
        org.hibernate.Query q = sess.createQuery("from dao.Procedure as c where c.Description = ?");
