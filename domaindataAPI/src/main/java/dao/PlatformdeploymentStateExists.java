...
public class PlatformdeploymentStateExists extends PlatformdeploymentState {
    ...
    public void meendplatformdeployment (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        ...
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 302");
    ...
    public void devicedeployment (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        ...
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 305");
        object.setState(state);
    }
    ...
    public void deviceundeployment (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        PlatformdeploymentStateExists state = PlatformdeploymentStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 307");
        object.setState(state);
    }
    ...
    public void mecrdeviceresult (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        PlatformdeploymentStateExists state = PlatformdeploymentStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 309");
        object.setState(state);
    }
    ...
    public void mecrdeviceusage (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        PlatformdeploymentStateExists state = PlatformdeploymentStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 311");
        object.setState(state);
    }
    ...
    public void meenddeviceresult (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        PlatformdeploymentStateExists state = PlatformdeploymentStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 313");
        object.setState(state);
    }
    ...
    public void meenddeviceusage (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        PlatformdeploymentStateExists state = PlatformdeploymentStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 315");
        object.setState(state);
    }
    ...
    public void mesetready (org.hibernate.Session sess, Platformdeployment object) throws org.hibernate.HibernateException {
        PlatformdeploymentStateExists state = PlatformdeploymentStateExists.getObject(sess);
        MerodeLogger.logln ("[" + Instant.now() + "]" + " Object " + object.getId() + " of object type 289 changed from state " + getStateId() + " to state " + state.getStateId() + " using method 317");
        object.setState(state);
    }
